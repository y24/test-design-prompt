...
* 例：
  ...
  * 「スケジュールに"環境構築期間"が含まれていますが、**具体的な作業内容**と**所要日数**を教えてください。」
  * 「テスト観点として"セキュリティ"が挙げられていますが、**具体的なテスト内容**と**判定基準**を教えてください。」
